    ...
    JSON.stringify(
      {
        ...
        rag_golden_version: result.report.rag_golden_version,
        rag_golden_source: result.report.rag_golden_source,
        rag_golden_sha256: result.report.rag_golden_sha256,
        source_behavior_golden_path: result.report.source_behavior_golden_path,
