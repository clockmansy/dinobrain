...
3. Context Packs use `hybrid_contextual_v2`: chunk context, BM25 sparse scoring, dense-lite lexical similarity, reciprocal rank fusion, and provenance-aware reranking.
...
8. Risk is evaluated with `os_gate`; destructive work, missing context, sensitive prompts, sync/release risk, and missing OS tools produce safe actions.
