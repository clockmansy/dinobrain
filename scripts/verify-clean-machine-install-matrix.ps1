...
try {
  ...
  $overlayPaths = @(
    ...
    "install.ps1",
    "installer/DinoBrainSetup/DinoBrainSetup.csproj",
    ...
    "scripts/verify-installer-native-runtime.ps1",
    "scripts/verify-installer-transaction.ps1",
    "scripts/start-windows-sandbox-clean-machine-proof.ps1",
    "scripts/windows-sandbox-clean-machine-bootstrap.ps1",
    "scripts/verify-windows-sandbox-clean-machine-proof.ps1",
